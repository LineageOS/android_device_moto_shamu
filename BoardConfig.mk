...
BOARD_CUSTOM_BT_CONFIG :=  $(LOCAL_PATH)/vnd_shamu.txt
...
# Gralloc
TARGET_ADDITIONAL_GRALLOC_10_USAGE_BITS := 0x020000000
...
TARGET_RECOVERY_FSTAB =  $(LOCAL_PATH)/rootdir/etc/fstab.shamu
